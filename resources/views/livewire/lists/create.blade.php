...
new class extends Component {
   ...
   # public string $name_column_name;
    ...
    {
        # increase memory limit to allow heavy data processing
        ...
        $count = 0;
        $chunkSize = 500;
        $chunks = array_chunk($email_entries, $chunkSize);
...
<div>
    ...
    <x-form wire:submit="save">
        ...
        <x-input label="Email-Column Name" wire:model="email_column_name"/>
